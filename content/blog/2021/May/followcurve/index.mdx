...
>Did you know? This w ebsite's full source code is open source and available for you to downlaod and use at your pleasure <a href="https://github.com/TedfordMedia/tedfordmedia">here</a>
...
and now we can put the "Model" in the scene after the curve ensuring to include it in Suspense tags with the Html message 'loading'.  Also note we have placed the model in a group to ensure problem free resizing that doesn't negatively effect the animation:
