...
..also amended the background color to black so now it shows:

![](stars.png)

Next.... make the scene Full height....we need to use the height units of vh like so:
...
There is of course, some adjustment to do, which we'll get to shortly, but for now, it's a good start.  Here is the code that created that:  A New function: **TheCurveThing**
