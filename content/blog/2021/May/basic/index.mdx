...
xxxThis site is build with Gatsby and R3F.  It's main cleverness is in using MDX components to enbale 3D Objects to appear in a page like these cubes here:  
