...
<RobotStarsScene/>
<Layout>  
<p>Welcome to our new site, build with React-Three-Fiber and Gatsby.  React-Three-Fiber brings the world of 3D into the site and Gatsby enables the fastest possible WebGL experience available.
